...
st.markdown("---")
st.write("Developed by Mohd Salik")
st.write("Copyright © 2024. All rights reserved.")
github_link = "https://github.com/DIECINIUM/Medical-Image-Classification" 
icon = "\U0001F517" 
st.write(f"Find code and model on [DIECINIUM]({github_link}){icon}")
